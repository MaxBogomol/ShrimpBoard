...
inline const uint8_t PROGMEM KEYBOARD_MATRIX[6][17] = {
    ...
    {KEY_NONE, KEY_LEFTCTRL, KEY_LEFTGUI, KEY_LEFTALT, KEY_NONE, KEY_NONE, KEY_RIGHTALT, KEY_RIGHTGUI, KEY_NONE, KEY_RIGHTCTRL, KEY_LEFT, KEY_DOWN, KEY_RIGHT, KEY_NONE, KEY_NONE, KEY_NONE, KEY_NONE}
};

inline const uint8_t PROGMEM KEYBOARD_MATRIX_FN[6][17] = {
...
inline const uint8_t PROGMEM KEYBOARD_MATRIX_FN_SHIFT[6][17] = {
...
inline const uint16_t PROGMEM KEYBOARD_MATRIX_MEDIA_KEYS_USB[6][17] = {
...
inline const uint32_t PROGMEM KEYBOARD_MATRIX_MEDIA_KEYS_BLE[6][17] = {
